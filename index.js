...
const showEvents = (events) => {
  ...
  const titleCityEvents = document.createElement("h2");
  titleCityEvents.textContent = `Events in ${events[0]._embedded.venues[0].city.name}`;
  eventsContainer.appendChild(titleCityEvents);
